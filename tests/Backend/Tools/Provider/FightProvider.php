...
final class FightProvider
{
    public static function initiatedFight(): Fight
    {
        return Fight::initiate(
            ...
            FightParticipantProvider::fightInitiator('a34f3829-b9bc-48c5-9fe5-7d58fe5f3db7', 25, 5, 1, 4, 17),
            FightParticipantProvider::fightOpponent('8cc8142a-d055-4e6d-b9dc-f2e06c967f93', 21, 4, 3, 1, 15),
        );
    }
    ...
    public static function fightWhereParticipantsCannotDamageEachOther(): Fight
    {
        return Fight::initiate(
            ...
            FightParticipantProvider::fightInitiator('127c8abd-7b0f-4e50-b315-5bbee38bd0e1', 25, 5, 5, 4, 17),
            FightParticipantProvider::fightOpponent('a0b5c4da-4814-4dc6-ab19-d6584f240410', 21, 4, 9, 1, 15),
        );
    }
    ...
    public static function fightWhereOnlyInitiatorCanDealDamages(): Fight
    {
        return Fight::initiate(
            ...
            FightParticipantProvider::fightInitiator('4611b1eb-282a-4863-80d5-6e51a3e8f765', 25, 5, 5, 4, 17),
            FightParticipantProvider::fightOpponent('c8d23fa7-ecdc-48fd-8d19-dd2ba7e37245', 21, 4, 3, 1, 15),
        );
    }
    ...
    public static function fightWhereOnlyOpponentCanDealDamages(): Fight
    {
        return Fight::initiate(
            new FightId('f098058d-c568-4c58-8ff2-47d0dfc339ae'),
            FightParticipantProvider::fightInitiator('127c8abd-7b0f-4e50-b315-5bbee38bd0e1', 25, 5, 1, 4, 17),
            FightParticipantProvider::fightOpponent('a0b5c4da-4814-4dc6-ab19-d6584f240410', 21, 4, 9, 1, 15),
        );
    }
    ...
    public static function fightWithThreeTurns(): Fight
    {
        ...
        ReflectionHelper::writePropertyValue($fight, 'turns', [
            FightTurn::create(
                ...
                FightParticipantProvider::fightInitiator('a34f3829-b9bc-48c5-9fe5-7d58fe5f3db7', 25, 5, 1, 4, 17),
                FightParticipantProvider::fightOpponent('8cc8142a-d055-4e6d-b9dc-f2e06c967f93', 19, 4, 3, 1, 15),
            ...
            FightTurn::create(
                ...
                FightParticipantProvider::fightOpponent('8cc8142a-d055-4e6d-b9dc-f2e06c967f93', 19, 4, 3, 1, 15),
                FightParticipantProvider::fightInitiator('a34f3829-b9bc-48c5-9fe5-7d58fe5f3db7', 20, 5, 1, 4, 17),
